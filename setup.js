...
// ^ OK i tried and the .answers thing didn't work. Thanks library
...
questions.push({type: "input", name: "site.domain", message: "Site: domain name for the site:", default: "localhost"})
questions.push({type: "input", name: "site.dsn", message: "Site: Sentry/GlitchTip dsn:", default: "disabled"})

const ans = await inquirer.prompt(questions)

if (ans.site.dsn === "disabled") {
    delete ans.site.dsn
}
